...
NUITKA_LOCAL_MODULE PyObject *impl_genexpr_1_of_function_2_main_of_module___main__( PyObject *_python_par___iterator, PyObjectSharedLocalVariable &closure_ok );


NUITKA_LOCAL_MODULE PyObject *impl_genexpr_2_of_function_2_main_of_module___main__( PyObject *_python_par___iterator, PyObjectSharedLocalVariable &closure_ok );


static PyObject *MAKE_FUNCTION_function_1_read_single_keypress_of_module___main__(  );


static PyObject *MAKE_FUNCTION_function_2_main_of_module___main__(  );


// The module function definitions.
static PyObject *impl_function_1_read_single_keypress_of_module___main__( Nuitka_FunctionObject *self )
{
    // No context is used.
    ...
    static PyFrameObject *frame_function_1_read_single_keypress_of_module___main__ = NULL;

    if ( isFrameUnusable( frame_function_1_read_single_keypress_of_module___main__ ) )
    {
        if ( frame_function_1_read_single_keypress_of_module___main__ )
        {
#if _DEBUG_REFRAME
            puts( "reframe for function_1_read_single_keypress_of_module___main__" );
#endif
            Py_DECREF( frame_function_1_read_single_keypress_of_module___main__ );
        }

        frame_function_1_read_single_keypress_of_module___main__ = MAKE_FRAME( codeobj_c7a7ff7951fbd0ad6988ad6a57e11c0f, module___main__ );
    }

    FrameGuardWithExceptionPreservation frame_guard( frame_function_1_read_single_keypress_of_module___main__ );
    try
    {
        assert( Py_REFCNT( frame_function_1_read_single_keypress_of_module___main__ ) == 2 ); // Frame stack
    ...
    catch ( PythonException &_exception )
    {
        ...
        if ( frame_guard.getFrame0() == frame_function_1_read_single_keypress_of_module___main__ )
        {
           Py_DECREF( frame_function_1_read_single_keypress_of_module___main__ );
           frame_function_1_read_single_keypress_of_module___main__ = NULL;
        }
...
static PyObject *fparse_function_1_read_single_keypress_of_module___main__( Nuitka_FunctionObject *self, PyObject **args, Py_ssize_t args_size, PyObject *kw )
{
    ...
    return impl_function_1_read_single_keypress_of_module___main__( self );
...
static PyObject *dparse_function_1_read_single_keypress_of_module___main__( Nuitka_FunctionObject *self, PyObject **args, int size )
{
    if ( size == 0 )
    {
        return impl_function_1_read_single_keypress_of_module___main__( self );
    ...
    {
        PyObject *result = fparse_function_1_read_single_keypress_of_module___main__( self, args, size, NULL );
        return result;
    }
...
static PyObject *impl_function_2_main_of_module___main__( Nuitka_FunctionObject *self )
{
    // No context is used.
    ...
    static PyFrameObject *frame_function_2_main_of_module___main__ = NULL;

    if ( isFrameUnusable( frame_function_2_main_of_module___main__ ) )
    {
        if ( frame_function_2_main_of_module___main__ )
        {
#if _DEBUG_REFRAME
            puts( "reframe for function_2_main_of_module___main__" );
#endif
            Py_DECREF( frame_function_2_main_of_module___main__ );
        }

        frame_function_2_main_of_module___main__ = MAKE_FRAME( codeobj_7cb1be52127cabbd50020a151364d7ef, module___main__ );
    }

    FrameGuard frame_guard( frame_function_2_main_of_module___main__ );
    try
    {
        assert( Py_REFCNT( frame_function_2_main_of_module___main__ ) == 2 ); // Frame stack
        ...
        if ( SEQUENCE_CONTAINS_BOOL( const_str_digest_5ecca9b6620eae51dccef385a03c452d, var_q_id.asObject0() ) )
        {
            ...
            try
            {
                ...
                while( true )
                {
                    ...
                    {
                        PyObjectTempKeeper1 call1;
                        var_filename.assign1( ( call1.assign( LOOKUP_ATTRIBUTE( const_str_empty, const_str_plain_join ) ), CALL_FUNCTION_WITH_ARGS1( call1.asObject0(), PyObjectTemporary( impl_genexpr_1_of_function_2_main_of_module___main__( MAKE_ITERATOR( PyObjectTemporary( LOOKUP_ATTRIBUTE( var_video.asObject0(), const_str_plain_title ) ).asObject0() ), var_ok ) ).asObject0() ) ) );
                    }
        ...
        else
        {
            ...
            {
                PyObjectTempKeeper1 call1;
                var_filename.assign1( ( call1.assign( LOOKUP_ATTRIBUTE( const_str_empty, const_str_plain_join ) ), CALL_FUNCTION_WITH_ARGS1( call1.asObject0(), PyObjectTemporary( impl_genexpr_2_of_function_2_main_of_module___main__( MAKE_ITERATOR( PyObjectTemporary( LOOKUP_ATTRIBUTE( var_video.asObject0(), const_str_plain_title ) ).asObject0() ), var_ok ) ).asObject0() ) ) );
            }
    ...
    catch ( PythonException &_exception )
    {
        ...
        if ( frame_guard.getFrame0() == frame_function_2_main_of_module___main__ )
        {
           Py_DECREF( frame_function_2_main_of_module___main__ );
           frame_function_2_main_of_module___main__ = NULL;
        }
...
static PyObject *fparse_function_2_main_of_module___main__( Nuitka_FunctionObject *self, PyObject **args, Py_ssize_t args_size, PyObject *kw )
{
    assert( kw == NULL || PyDict_Check( kw ) );
    ...
    return impl_function_2_main_of_module___main__( self );
...
static PyObject *dparse_function_2_main_of_module___main__( Nuitka_FunctionObject *self, PyObject **args, int size )
{
    if ( size == 0 )
    {
        return impl_function_2_main_of_module___main__( self );
    ...
    {
        PyObject *result = fparse_function_2_main_of_module___main__( self, args, size, NULL );
        return result;
    }
...
struct _context_generator_genexpr_1_of_function_2_main_of_module___main___t
{
...
static void _context_generator_genexpr_1_of_function_2_main_of_module___main___destructor( void *context_voidptr )
{
    _context_generator_genexpr_1_of_function_2_main_of_module___main___t *_python_context = (struct _context_generator_genexpr_1_of_function_2_main_of_module___main___t *)context_voidptr;

    delete _python_context;
}

static void genexpr_1_of_function_2_main_of_module___main___context( Nuitka_GeneratorObject *generator )
{
    try
    {
        // Make context accessible if one is used.

        NUITKA_MAY_BE_UNUSED struct _context_generator_genexpr_1_of_function_2_main_of_module___main___t *_python_context = (_context_generator_genexpr_1_of_function_2_main_of_module___main___t *)generator->m_context;
        ...
        // Actual function code.
        static PyFrameObject *frame_genexpr_1_of_function_2_main_of_module___main__ = NULL;

        // Must be inside block, or else its d-tor will not be run.
        if ( isFrameUnusable( frame_genexpr_1_of_function_2_main_of_module___main__ ) )
        {
            if ( frame_genexpr_1_of_function_2_main_of_module___main__ )
            {
#if _DEBUG_REFRAME
                puts( "reframe for genexpr_1_of_function_2_main_of_module___main__" );
#endif
                Py_DECREF( frame_genexpr_1_of_function_2_main_of_module___main__ );
            }

            frame_genexpr_1_of_function_2_main_of_module___main__ = MAKE_FRAME( codeobj_8df00f5d9bf0db116cffc718258538d2, module___main__ );
        }

        Py_INCREF( frame_genexpr_1_of_function_2_main_of_module___main__ );
        generator->m_frame = frame_genexpr_1_of_function_2_main_of_module___main__;
...
static PyObject *impl_genexpr_1_of_function_2_main_of_module___main__( PyObject *_python_par___iterator, PyObjectSharedLocalVariable &closure_ok )
{
    // Create context if any
    struct _context_generator_genexpr_1_of_function_2_main_of_module___main___t *_python_context = new _context_generator_genexpr_1_of_function_2_main_of_module___main___t;
    _python_context->closure_ok.shareWith( closure_ok );

    try
    {
        PyObject *result = Nuitka_Generator_New(
            genexpr_1_of_function_2_main_of_module___main___context,
            const_str_angle_genexpr,
            codeobj_3ebee9d399fc4c818b84d10bc52bb9bb,
            _python_context,
            _context_generator_genexpr_1_of_function_2_main_of_module___main___destructor
        );
...
struct _context_generator_genexpr_2_of_function_2_main_of_module___main___t
{
    // The generator function instance can access its parameters from creation time.
    PyObjectClosureVariable closure_ok;
    PyObjectLocalParameterVariableNoDel par___iterator;
...
static void _context_generator_genexpr_2_of_function_2_main_of_module___main___destructor( void *context_voidptr )
{
    _context_generator_genexpr_2_of_function_2_main_of_module___main___t *_python_context = (struct _context_generator_genexpr_2_of_function_2_main_of_module___main___t *)context_voidptr;

    delete _python_context;
}

static void genexpr_2_of_function_2_main_of_module___main___context( Nuitka_GeneratorObject *generator )
{
    try
    {
        // Make context accessible if one is used.

        NUITKA_MAY_BE_UNUSED struct _context_generator_genexpr_2_of_function_2_main_of_module___main___t *_python_context = (_context_generator_genexpr_2_of_function_2_main_of_module___main___t *)generator->m_context;
        ...
        // Actual function code.
        static PyFrameObject *frame_genexpr_2_of_function_2_main_of_module___main__ = NULL;

        // Must be inside block, or else its d-tor will not be run.
        if ( isFrameUnusable( frame_genexpr_2_of_function_2_main_of_module___main__ ) )
        {
            if ( frame_genexpr_2_of_function_2_main_of_module___main__ )
            {
#if _DEBUG_REFRAME
                puts( "reframe for genexpr_2_of_function_2_main_of_module___main__" );
#endif
                Py_DECREF( frame_genexpr_2_of_function_2_main_of_module___main__ );
            }

            frame_genexpr_2_of_function_2_main_of_module___main__ = MAKE_FRAME( codeobj_b234c3e0a7eb677c4d0561737a704c4d, module___main__ );
        }

        Py_INCREF( frame_genexpr_2_of_function_2_main_of_module___main__ );
        generator->m_frame = frame_genexpr_2_of_function_2_main_of_module___main__;
...
static PyObject *impl_genexpr_2_of_function_2_main_of_module___main__( PyObject *_python_par___iterator, PyObjectSharedLocalVariable &closure_ok )
{
    // Create context if any
    struct _context_generator_genexpr_2_of_function_2_main_of_module___main___t *_python_context = new _context_generator_genexpr_2_of_function_2_main_of_module___main___t;
    _python_context->closure_ok.shareWith( closure_ok );

    try
    {
        PyObject *result = Nuitka_Generator_New(
            genexpr_2_of_function_2_main_of_module___main___context,
            const_str_angle_genexpr,
            codeobj_70ee4a089d751ce8d8ba259f08111a8f,
            _python_context,
            _context_generator_genexpr_2_of_function_2_main_of_module___main___destructor
        );
...
static PyObject *MAKE_FUNCTION_function_1_read_single_keypress_of_module___main__(  )
{
    PyObject *result = Nuitka_Function_New(
        fparse_function_1_read_single_keypress_of_module___main__,
        dparse_function_1_read_single_keypress_of_module___main__,
        const_str_plain_read_single_keypress,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_cf2dde3cd2260779520ecbe6f4a712ee,
...
{
    PyObject *result = Nuitka_Function_New(
        fparse_function_2_main_of_module___main__,
        dparse_function_2_main_of_module___main__,
        const_str_plain_main,
#if PYTHON_VERSION >= 330
        NULL,
#endif
        codeobj_822a82ec0a3bc45359fdcfa816877bcf,
        INCREASE_REFCOUNT( Py_None ),
#if PYTHON_VERSION >= 300
        INCREASE_REFCOUNT( Py_None ),
        NULL,
...
{
    { (char *)"download", MOD_INIT_NAME( download ), NUITKA_COMPILED_MODULE },
    { (char *)"pafy", MOD_INIT_NAME( pafy ), NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0 }
};
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    // Module code
    PyFrameObject *frame_module___main__ = MAKE_FRAME( codeobj_c016a6bbc4bee0c08d3a420ed96d3e5e, module___main__ );
    ...
    try
    {
        ...
        UPDATE_STRING_DICT0( moduledict___main__, (Nuitka_StringObject *)const_str_plain___file__, const_str_digest_5cc89711cb3a866ca37f713615b12505 );
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_termios, IMPORT_MODULE( const_str_plain_termios, ((PyModuleObject *)module___main__)->md_dict, ((PyModuleObject *)module___main__)->md_dict, Py_None, const_int_neg_1 ) );
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_fcntl, IMPORT_MODULE( const_str_plain_fcntl, ((PyModuleObject *)module___main__)->md_dict, ((PyModuleObject *)module___main__)->md_dict, Py_None, const_int_neg_1 ) );
        ...
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_json, IMPORT_MODULE( const_str_plain_json, ((PyModuleObject *)module___main__)->md_dict, ((PyModuleObject *)module___main__)->md_dict, Py_None, const_int_neg_1 ) );
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_urllib2, IMPORT_MODULE( const_str_plain_urllib2, ((PyModuleObject *)module___main__)->md_dict, ((PyModuleObject *)module___main__)->md_dict, Py_None, const_int_neg_1 ) );
        ...
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_pafy, IMPORT_MODULE( const_str_plain_pafy, ((PyModuleObject *)module___main__)->md_dict, ((PyModuleObject *)module___main__)->md_dict, Py_None, const_int_neg_1 ) );
        UPDATE_STRING_DICT0( moduledict___main__, (Nuitka_StringObject *)const_str_plain_debug, Py_True );
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_read_single_keypress, MAKE_FUNCTION_function_1_read_single_keypress_of_module___main__(  ) );
        UPDATE_STRING_DICT1( moduledict___main__, (Nuitka_StringObject *)const_str_plain_main, MAKE_FUNCTION_function_2_main_of_module___main__(  ) );
        ...
        DECREASE_REFCOUNT( CALL_FUNCTION_NO_ARGS( LOOKUP_BUILTIN( const_str_plain_exit ) ) );
    }
    catch ( PythonException &_exception )
    {
        if ( !_exception.hasTraceback() )
...
int main( int argc, char *argv[] )
{
    ...
    if ( ERROR_OCCURED() )
    {
        ...
        PyThreadState_GET()->frame = MAKE_FRAME( codeobj_c016a6bbc4bee0c08d3a420ed96d3e5e, module___main__ );
